...
#*-*-*-*-**-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*-*#
        print(24*'-')
        if len(acertoarray) == 0:
            pacerto = 0
            p10acerto = 0
            p20acerto = 0
        else:
            pacerto = sum(acertoarray) / len(acertoarray)
            p10acerto = sum(acertoarray) / (len(acertoarray) + 160)
            if (len(acertoarray) - 160) <= 0:
                p20acerto = 0
            else:
                p20acerto = sum(acertoarray) / (len(acertoarray) - 160)
