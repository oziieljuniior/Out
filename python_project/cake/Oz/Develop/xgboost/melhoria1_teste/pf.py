...
def reden(array1, array2):
    """
    Treina um modelo XGBoost para classificação binária e realiza ajuste de hiperparâmetros.
    
    Args:
        features (numpy.array): Matriz de características preditoras.
        labels (numpy.array): Vetor de rótulos binários (0 ou 1).
    
    Returns:
        xgb.XGBClassifier: Modelo treinado com os melhores hiperparâmetros.
    """
    ...
    random_search = RandomizedSearchCV(
        estimator=xgb.XGBClassifier(objective='multi:softmax', num_class=2, random_state=42),
    ...
    print(f'F1-Score do modelo otimizado: {f1:.4f}')
