...
def reden(array1, array2):
    """
    Função para treinar um modelo XGBoost de regressão usando as entradas e saídas fornecidas.
    ...
    model = xgb.XGBRegressor(
        objective='reg:logistic',  # Função de perda para regressão logística (saída em [0, 1])
        learning_rate=0.01,  # Taxa de aprendizado menor para convergência estável
        ...
        colsample_bytree=0.8,  # Seleção de features por árvore
        gamma=0.1,  # Penalização para divisões irrelevantes
